...
<div class="content ">
    ...
    <div class="table-responsive" id="allExpense">
                    ...
                    <!-- <td class="text-end">
                        <div class="d-flex">
                            <div class="dropdown ms-auto">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a href="javascript:;" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#ShowExpenseModal">Show</a>
                                    <a href="javascript:;" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#EditExpenseModal">Edit</a>
                                    <a href="javascript:;" class="dropdown-item deleteExpense">Delete</a>
                                </div>
                            </div>
                        </div>
                    </td> -->
