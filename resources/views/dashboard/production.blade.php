...
<div class="row">
    <div class="col-lg-8 col-md-12">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <h6 class="card-title mb-4">Tasks this month</h6>
                <div id="profit"></div>
            </div>
        </div>
        <div class="card mb-4">
    ...
    <div class="col-lg-4 col-md-12">
        ...
        <div class="card widget">
            ...
            <div class="card-body">
                <p class="text-muted">Tasks added today.
                    details</p>
    ...
    <div class="col-lg-6 col-md-12">
        <div class="card widget">
            ...
            <div class="card-body">
                <p class="text-muted">Revisions added today. 
                <div class="table-responsive">
