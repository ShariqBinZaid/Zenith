...
class ProjectsController extends Controller
{
    ...
    {
        $projects = Projects::where('status','pending')->latest()->with('getBrand')->with('getPackage')->with('getCustomer')->with('getConverter')->with('getProjectType')->paginate(10);
        ...
        return view('projects.index',compact(['projects','clients','projecttype','brandspackages']));
    }
